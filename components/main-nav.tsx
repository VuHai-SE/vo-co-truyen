        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-10">
            <div className="flex items-center space-x-4">
              <Link href="https://www.facebook.com/vocotruyentphcmvn" className="hover:opacity-80" target="_blank" rel="noopener noreferrer">
              ...
              <Link href="https://www.youtube.com/@liendoanvocotruyentphochiminh" className="hover:opacity-80" target="_blank" rel="noopener noreferrer">
